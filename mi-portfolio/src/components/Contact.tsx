      ...
      >
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          <a
            ...
            className="bg-[#00e5a0] hover:bg-[#00d991] text-[#080b10] font-bold text-sm px-9 py-3.5 rounded-lg tracking-wide hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(0,229,160,0.4)] transition-all duration-200 active:scale-95 inline-block"
          >
            Escribime
          </a>
